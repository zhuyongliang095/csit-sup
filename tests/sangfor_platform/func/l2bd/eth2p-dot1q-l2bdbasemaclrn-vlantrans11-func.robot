...
|    | [Documentation] | [Top] TG-DUT1-DUT2-TG. [Enc] Eth-dot1q-IPv4-ICMPv4 on TG-DUT1 and \ DUT1-DUT2, Eth-IPv4-ICMPv4 on TG-DUT2. [Cfg] On DUT1 configure L2 |
...
|    | ${vlan1_name} | ${vlan1_index}= | When Create vlan sub-interface | ${dut1_node} | ${dut1_to_tg} | ${outer_vlan_id1} |
|    | ${vlan2_name} | ${vlan2_index}= | And Create vlan sub-interface | ${dut2_node} | ${dut2_to_dut1} | ${outer_vlan_id2} |
|    | And Configure L2 tag rewrite method on interface | ${dut1_node} | ${vlan1_index} | translate-1-1 | tag1_id=${outer_vlan_id2} |
|    | And Configure L2 tag rewrite method on interface | ${dut2_node} | ${vlan2_index} | pop-1 |
|    | And Create bridge domain | ${dut1_node} | ${bd_id1} |
|    | And Add interface to bridge domain | ${dut1_node} | ${dut1_to_dut2} | ${bd_id1} |
|    | And Add interface to bridge domain | ${dut1_node} | ${vlan1_index} | ${bd_id1} |
|    | And Create bridge domain | ${dut2_node} | ${bd_id1} |
|    | And Add interface to bridge domain | ${dut2_node} | ${dut2_to_tg} | ${bd_id1} |
|    | And Add interface to bridge domain | ${dut2_node} | ${vlan2_index} | ${bd_id1} |
|    | Then Send ICMP packet and verify received packet | ${tg_node} | ${tg_to_dut1} | ${tg_to_dut2} | encaps=Dot1q | vlan1=${outer_vlan_id1} |
